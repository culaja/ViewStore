...
{
    public sealed class FetchingGlobalPositionFromCacheTests
    {
        ...
        public FetchingGlobalPositionFromCacheTests()
        {
        ...
        public async Task check_global_position_after_adding_two_views_and_when_drain_is_not_triggered(
            ...
            long expectedPart1, long expectedPart2)
        {
            ...
            (await _viewStoreCacheInternal.ReadLastKnownPositionAsync())
                .Should()
        ...
        [InlineData(2, 1,    2, 2,    2, 2)]
        [InlineData(0, 1,    0, 5,    0, 5)]
        public async Task check_global_position_after_adding_two_views_and_when_drain_is_triggered(
            long partA1, long partA2,
            long partB1, long partB2,
            long expectedPart1, long expectedPart2)
        {
        ...
        [InlineData(2, 1,    2, 2,    2, 2)]
        [InlineData(0, 1,    0, 5,    0, 5)]
        public async Task check_global_position_after_adding_two_views_and_when_drain_is_triggered_between_two_saves(
            long partA1, long partA2,
            long partB1, long partB2,
            long expectedPart1, long expectedPart2)
        {
        ...
        [InlineData(2, 1,    2, 2,    2, 2)]
        [InlineData(0, 1,    0, 5,    0, 5)]
        public async Task check_global_position_after_adding_two_views_and_after_two_consecutive_drains(
            long partA1, long partA2,
            long partB1, long partB2,
            long expectedPart1, long expectedPart2)
        {
